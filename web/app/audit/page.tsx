  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border bg-white p-4 space-y-3">
        ...
        <input className="w-full rounded-md border px-3 py-2" value={tenantId} onChange={e=>setTenantId(e.target.value)} placeholder="22222222-..." />
      </div>
      <div className="overflow-x-auto rounded-lg border bg-white">
        <table className="min-w-full text-sm">
          ...
          <tbody>
            {content.map((a: any) => (
              <tr key={a.id ?? `${a.entityId}-${a.createdAt ?? a.created_at}` } className="border-t">
